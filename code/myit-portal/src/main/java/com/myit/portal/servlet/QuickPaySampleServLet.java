...
/**
 * 名称：支付请求类 功能：servlet方式支付类请求 类属性： 版本：1.0 日期：2011-03-11 作者：中国银联UPOP团队 版权：中国银联
...
public class QuickPaySampleServLet extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) {
        ...
        /*
         * 说明：以下代码直接返回跳转到银联在线支付页面字符串 new QuickPayUtils().createPayHtml(valueVo, signType)
         */
         ...
         * QuickPayUtils().createPayHtml(valueVo, "CCB", signType)
         */
