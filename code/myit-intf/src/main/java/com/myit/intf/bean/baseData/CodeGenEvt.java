 ...
 * @version 1.0.0
 */
public class CodeGenEvt extends BaseModel implements Serializable {
    /**
     * generate sid
     */
     ...
     * @param codeDescribe
     */
    public CodeGenEvt(Long id, String codeType, int curValue, String genTpl, String codeDescribe, Date createTime,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CodeGenEvt other = (CodeGenEvt) obj;
