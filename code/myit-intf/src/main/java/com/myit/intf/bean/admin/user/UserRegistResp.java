 ...
 * @version 1.0.0
 */
public class UserRegistResp extends BaseModel implements Serializable {
    /**
     * generate sid
     */
    ...
    public UserRegistResp() {
    }

    public UserRegistResp(Long id, String memberNo, String realName, String sex, Timestamp birthday, String provinceId,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        UserRegistResp other = (UserRegistResp) obj;
