 ...
 * @version 1.0.0
 */
public class LoginResp extends BaseModel implements Serializable {
    /**
     * generate sid
     */
    ...
    public LoginResp(Long id, String memberNo, String realName, String sex, Timestamp birthday, String provinceId,
    ...
    public String toString() {
        return "LoginResp [id=" + this.getId() + ", memberNo=" + memberNo + ", realName=" + realName + ", sex=" + sex
