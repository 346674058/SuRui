package com.myit.server.model.member;
 ...
 * @version 1.0.0
 */
public class MemberInfo extends BaseModel implements Serializable {
    /** generate sid **/
    ...
    public MemberInfo(Long id, String account, String nick, String sex, Timestamp birthday, String province,
