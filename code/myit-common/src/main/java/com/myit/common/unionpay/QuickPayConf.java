package com.myit.common.unionpay;
...
public class QuickPayConf {
	...
	//交易类型
	public final static String TRADETYPE_PAY = "01";
	
	//货币种类：156-RMB
	public final static String CURRENCY_CODE = "156";
	
	//交易超时时间：300000毫秒
	public final static String TIMEOUT = "300000";
...
//	private final static String UPOP_QUERY_BASE_URL = "https://www.epay.lxdns.com/UpopWeb/api/";
	...
	// 商户名称
	public final static String merName = "订餐宝";

	public final static String merFrontEndUrl = "http://127.0.0.1:8080/order/payResult.htm";

	public final static String merBackEndUrl = "http://127.0.0.1:8081/order/payCallback.htm";
